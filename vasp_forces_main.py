...
print('\nName\t\tFx\t\t\tFy\t\t\tFz\t\t\tDisplacement [2nd - 1st]\n-------------------------------------------------------------------------')
print('Step 1\t\t%1.3f\t\t%1.3f\t\t%1.3f' % (np.max(np.absolute(data_first[:, 3])), np.max(np.absolute(data_first[:, 4])), np.max(np.absolute(data_first[:, 5]))))
print('Step 2\t\t%1.3f\t\t%1.3f\t\t%1.3f\t\t%1.3f' % (np.max(np.absolute(data_last[:, 3])), np.max(np.absolute(data_last[:, 4])), np.max(np.absolute(data_last[:, 5])), np.max(data_dif)))
